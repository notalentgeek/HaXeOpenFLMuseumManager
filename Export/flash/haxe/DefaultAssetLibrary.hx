...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/Layout/UIPopupEditObjectVisitor.xml", __ASSET__assets_layout_uipopupeditobjectvisitor_xml);
		...
		className.set ("assets/Layout/UIPopupAddObjectVisitor.xml", __ASSET__assets_layout_uipopupaddobjectvisitor_xml);
		type.set ("assets/Layout/UIPopupAddObjectVisitor.xml", AssetType.TEXT);
		className.set ("assets/Layout/UIPopupRemoveObjectVisitor.xml", __ASSET__assets_layout_uipopupremoveobjectvisitor_xml);
		...
		className.set ("assets/Layout/UIPopupRemoveObjectTag.xml", __ASSET__assets_layout_uipopupremoveobjecttag_xml);
		...
		className.set ("assets/Layout/UIPopupEditObjectTag.xml", __ASSET__assets_layout_uipopupeditobjecttag_xml);
		type.set ("assets/Layout/UIPopupEditObjectTag.xml", AssetType.TEXT);
		className.set ("assets/Layout/UIPopupAddObjectTag.xml", __ASSET__assets_layout_uipopupaddobjecttag_xml);
		type.set ("assets/Layout/UIPopupAddObjectTag.xml", AssetType.TEXT);
		className.set ("layout/UIPopupEditObjectVisitor.xml", __ASSET__layout_uipopupeditobjectvisitor_xml);
		...
		className.set ("layout/UIPopupAddObjectVisitor.xml", __ASSET__layout_uipopupaddobjectvisitor_xml);
		type.set ("layout/UIPopupAddObjectVisitor.xml", AssetType.TEXT);
		className.set ("layout/UIPopupRemoveObjectVisitor.xml", __ASSET__layout_uipopupremoveobjectvisitor_xml);
		...
		className.set ("layout/UIPopupRemoveObjectTag.xml", __ASSET__layout_uipopupremoveobjecttag_xml);
		...
		className.set ("layout/UIPopupEditObjectTag.xml", __ASSET__layout_uipopupeditobjecttag_xml);
		type.set ("layout/UIPopupEditObjectTag.xml", AssetType.TEXT);
		className.set ("layout/UIPopupAddObjectTag.xml", __ASSET__layout_uipopupaddobjecttag_xml);
...
@:keep @:bind #if display private #end class __ASSET__assets_layout_uipopupeditobjectvisitor_xml extends flash.utils.ByteArray { }
...
@:keep @:bind #if display private #end class __ASSET__assets_layout_uipopupaddobjectvisitor_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_layout_uipopupremoveobjectvisitor_xml extends flash.utils.ByteArray { }
...
@:keep @:bind #if display private #end class __ASSET__assets_layout_uipopupremoveobjecttag_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_layout_uipopupaddobjectmuseum_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_layout_uipopupeditobjecttag_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_layout_uipopupaddobjecttag_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__layout_uipopupeditobjectvisitor_xml extends flash.utils.ByteArray { }
...
@:keep @:bind #if display private #end class __ASSET__layout_uipopupaddobjectvisitor_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__layout_uipopupremoveobjectvisitor_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__layout_uipopupremoveobjectmuseum_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__layout_uipopupremoveobjecttag_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__layout_uipopupaddobjectmuseum_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__layout_uipopupeditobjecttag_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__layout_uipopupaddobjecttag_xml extends flash.utils.ByteArray { }
...
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/default/circle.png") #if display private #end class __ASSET__styles_default_circle_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/default/collapse.png") #if display private #end class __ASSET__styles_default_collapse_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/default/expand.png") #if display private #end class __ASSET__styles_default_expand_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/default/up_down.png") #if display private #end class __ASSET__styles_default_up_down_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/default/cross.png") #if display private #end class __ASSET__styles_default_cross_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/gripper_vertical.png") #if display private #end class __ASSET__styles_gradient_gripper_vertical_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/arrow_left.png") #if display private #end class __ASSET__styles_gradient_arrow_left_png extends lime.graphics.Image {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/gradient.css") #if display private #end class __ASSET__styles_gradient_gradient_css extends lime.utils.Bytes {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/gripper_horizontal.png") #if display private #end class __ASSET__styles_gradient_gripper_horizontal_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/hsplitter_gripper.png") #if display private #end class __ASSET__styles_gradient_hsplitter_gripper_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/arrow_down_dark.png") #if display private #end class __ASSET__styles_gradient_arrow_down_dark_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/gripper_horizontal_disabled.png") #if display private #end class __ASSET__styles_gradient_gripper_horizontal_disabled_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/cross_light_small.png") #if display private #end class __ASSET__styles_gradient_cross_light_small_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/arrow_down.png") #if display private #end class __ASSET__styles_gradient_arrow_down_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/gripper_vertical_disabled.png") #if display private #end class __ASSET__styles_gradient_gripper_vertical_disabled_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/arrow_left_disabled.png") #if display private #end class __ASSET__styles_gradient_arrow_left_disabled_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/circle_dark.png") #if display private #end class __ASSET__styles_gradient_circle_dark_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/arrow_right_dark.png") #if display private #end class __ASSET__styles_gradient_arrow_right_dark_png extends lime.graphics.Image {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/gradient_mobile.min.css") #if display private #end class __ASSET__styles_gradient_gradient_mobile_min_css extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/gradient_mobile.css") #if display private #end class __ASSET__styles_gradient_gradient_mobile_css extends lime.utils.Bytes {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/vsplitter_gripper.png") #if display private #end class __ASSET__styles_gradient_vsplitter_gripper_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/cross_dark.png") #if display private #end class __ASSET__styles_gradient_cross_dark_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/cross_dark_disabled.png") #if display private #end class __ASSET__styles_gradient_cross_dark_disabled_png extends lime.graphics.Image {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/gradient.min.css") #if display private #end class __ASSET__styles_gradient_gradient_min_css extends lime.utils.Bytes {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/arrow_right.png") #if display private #end class __ASSET__styles_gradient_arrow_right_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/arrow_down_disabled.png") #if display private #end class __ASSET__styles_gradient_arrow_down_disabled_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/arrow_up.png") #if display private #end class __ASSET__styles_gradient_arrow_up_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/arrow_right2.png") #if display private #end class __ASSET__styles_gradient_arrow_right2_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/arrow_right_disabled.png") #if display private #end class __ASSET__styles_gradient_arrow_right_disabled_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/gradient/arrow_up_disabled.png") #if display private #end class __ASSET__styles_gradient_arrow_up_disabled_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/glyphs/hscroll_thumb_gripper_down.png") #if display private #end class __ASSET__styles_windows_glyphs_hscroll_thumb_gripper_down_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/glyphs/right_arrow.png") #if display private #end class __ASSET__styles_windows_glyphs_right_arrow_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/glyphs/left_arrow.png") #if display private #end class __ASSET__styles_windows_glyphs_left_arrow_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/glyphs/vscroll_thumb_gripper_over.png") #if display private #end class __ASSET__styles_windows_glyphs_vscroll_thumb_gripper_over_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/glyphs/vscroll_thumb_gripper_up.png") #if display private #end class __ASSET__styles_windows_glyphs_vscroll_thumb_gripper_up_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/glyphs/hscroll_thumb_gripper_up.png") #if display private #end class __ASSET__styles_windows_glyphs_hscroll_thumb_gripper_up_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/glyphs/hscroll_thumb_gripper_over.png") #if display private #end class __ASSET__styles_windows_glyphs_hscroll_thumb_gripper_over_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/glyphs/vscroll_thumb_gripper_down.png") #if display private #end class __ASSET__styles_windows_glyphs_vscroll_thumb_gripper_down_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/glyphs/up_arrow.png") #if display private #end class __ASSET__styles_windows_glyphs_up_arrow_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/glyphs/down_arrow.png") #if display private #end class __ASSET__styles_windows_glyphs_down_arrow_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/checkbox.png") #if display private #end class __ASSET__styles_windows_checkbox_png extends lime.graphics.Image {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/buttons.css") #if display private #end class __ASSET__styles_windows_buttons_css extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/accordion.css") #if display private #end class __ASSET__styles_windows_accordion_css extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/windows.css") #if display private #end class __ASSET__styles_windows_windows_css extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/tabs.css") #if display private #end class __ASSET__styles_windows_tabs_css extends lime.utils.Bytes {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/hprogress.png") #if display private #end class __ASSET__styles_windows_hprogress_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/popup.png") #if display private #end class __ASSET__styles_windows_popup_png extends lime.graphics.Image {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/accordion.min.css") #if display private #end class __ASSET__styles_windows_accordion_min_css extends lime.utils.Bytes {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/container.png") #if display private #end class __ASSET__styles_windows_container_png extends lime.graphics.Image {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/scrolls.css") #if display private #end class __ASSET__styles_windows_scrolls_css extends lime.utils.Bytes {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/listview.png") #if display private #end class __ASSET__styles_windows_listview_png extends lime.graphics.Image {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/sliders.css") #if display private #end class __ASSET__styles_windows_sliders_css extends lime.utils.Bytes {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/textinput.png") #if display private #end class __ASSET__styles_windows_textinput_png extends lime.graphics.Image {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/listview.css") #if display private #end class __ASSET__styles_windows_listview_css extends lime.utils.Bytes {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/vscroll.png") #if display private #end class __ASSET__styles_windows_vscroll_png extends lime.graphics.Image {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/listview.min.css") #if display private #end class __ASSET__styles_windows_listview_min_css extends lime.utils.Bytes {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/button.png") #if display private #end class __ASSET__styles_windows_button_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/optionbox.png") #if display private #end class __ASSET__styles_windows_optionbox_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/vprogress.png") #if display private #end class __ASSET__styles_windows_vprogress_png extends lime.graphics.Image {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/popups.css") #if display private #end class __ASSET__styles_windows_popups_css extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/buttons.min.css") #if display private #end class __ASSET__styles_windows_buttons_min_css extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/scrolls.min.css") #if display private #end class __ASSET__styles_windows_scrolls_min_css extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/calendar.css") #if display private #end class __ASSET__styles_windows_calendar_css extends lime.utils.Bytes {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/tab.png") #if display private #end class __ASSET__styles_windows_tab_png extends lime.graphics.Image {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/rtf.css") #if display private #end class __ASSET__styles_windows_rtf_css extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/menus.css") #if display private #end class __ASSET__styles_windows_menus_css extends lime.utils.Bytes {}
@:image("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/styles/windows/hscroll.png") #if display private #end class __ASSET__styles_windows_hscroll_png extends lime.graphics.Image {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/fonts/Oxygen-Bold.eot") #if display private #end class __ASSET__fonts_oxygen_bold_eot extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/fonts/Oxygen.svg") #if display private #end class __ASSET__fonts_oxygen_svg extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/fonts/Oxygen.woff") #if display private #end class __ASSET__fonts_oxygen_woff extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/fonts/Oxygen.eot") #if display private #end class __ASSET__fonts_oxygen_eot extends lime.utils.Bytes {}
@:font("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/fonts/Oxygen-Bold.ttf") #if display private #end class __ASSET__fonts_oxygen_bold_ttf extends lime.text.Font {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/fonts/Oxygen.woff2") #if display private #end class __ASSET__fonts_oxygen_woff2 extends lime.utils.Bytes {}
@:font("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/fonts/Oxygen.ttf") #if display private #end class __ASSET__fonts_oxygen_ttf extends lime.text.Font {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/fonts/Oxygen-Bold.woff2") #if display private #end class __ASSET__fonts_oxygen_bold_woff2 extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/fonts/Oxygen-Bold.svg") #if display private #end class __ASSET__fonts_oxygen_bold_svg extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui/1,8,17/assets/fonts/Oxygen-Bold.woff") #if display private #end class __ASSET__fonts_oxygen_bold_woff extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/openfl.svg") #if display private #end class __ASSET__assets_openfl_svg extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/css/code.css") #if display private #end class __ASSET__assets_css_code_css extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/css/code.min.css") #if display private #end class __ASSET__assets_css_code_min_css extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/css/rtf.min.css") #if display private #end class __ASSET__assets_css_rtf_min_css extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/css/rtf.css") #if display private #end class __ASSET__assets_css_rtf_css extends lime.utils.Bytes {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-alignment-justify.png") #if display private #end class __ASSET__assets_img_rtfview_edit_alignment_justify_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-bold.png") #if display private #end class __ASSET__assets_img_rtfview_edit_bold_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-alignment-left.png") #if display private #end class __ASSET__assets_img_rtfview_edit_alignment_left_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-alignment-center.png") #if display private #end class __ASSET__assets_img_rtfview_edit_alignment_center_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-underline.png") #if display private #end class __ASSET__assets_img_rtfview_edit_underline_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-alignment-right.png") #if display private #end class __ASSET__assets_img_rtfview_edit_alignment_right_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-list.png") #if display private #end class __ASSET__assets_img_rtfview_edit_list_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-italic.png") #if display private #end class __ASSET__assets_img_rtfview_edit_italic_png extends lime.graphics.Image {}
@:file("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/ui/example.txt") #if display private #end class __ASSET__assets_ui_example_txt extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/ui/example.hx") #if display private #end class __ASSET__assets_ui_example_hx extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/ui/example.xml") #if display private #end class __ASSET__assets_ui_example_xml extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/ui/demo.xml") #if display private #end class __ASSET__assets_ui_demo_xml extends lime.utils.Bytes {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-alignment-justify.png") #if display private #end class __ASSET__img_rtfview_edit_alignment_justify_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-bold.png") #if display private #end class __ASSET__img_rtfview_edit_bold_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-alignment-left.png") #if display private #end class __ASSET__img_rtfview_edit_alignment_left_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-alignment-center.png") #if display private #end class __ASSET__img_rtfview_edit_alignment_center_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-underline.png") #if display private #end class __ASSET__img_rtfview_edit_underline_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-alignment-right.png") #if display private #end class __ASSET__img_rtfview_edit_alignment_right_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-list.png") #if display private #end class __ASSET__img_rtfview_edit_list_png extends lime.graphics.Image {}
@:image("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/img/rtfview/edit-italic.png") #if display private #end class __ASSET__img_rtfview_edit_italic_png extends lime.graphics.Image {}
@:file("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/css/code.css") #if display private #end class __ASSET__css_code_css extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/css/code.min.css") #if display private #end class __ASSET__css_code_min_css extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/css/rtf.min.css") #if display private #end class __ASSET__css_rtf_min_css extends lime.utils.Bytes {}
@:file("/home/notalentgeek/haxelib/haxeui-rich-text/0,1,2/assets/css/rtf.css") #if display private #end class __ASSET__css_rtf_css extends lime.utils.Bytes {}
@:file("Assets/Layout/UIPopupEditObjectVisitor.xml") #if display private #end class __ASSET__assets_layout_uipopupeditobjectvisitor_xml extends lime.utils.Bytes {}
...
@:file("Assets/Layout/UIPopupAddObjectVisitor.xml") #if display private #end class __ASSET__assets_layout_uipopupaddobjectvisitor_xml extends lime.utils.Bytes {}
@:file("Assets/Layout/UIPopupRemoveObjectVisitor.xml") #if display private #end class __ASSET__assets_layout_uipopupremoveobjectvisitor_xml extends lime.utils.Bytes {}
...
@:file("Assets/Layout/UIPopupRemoveObjectTag.xml") #if display private #end class __ASSET__assets_layout_uipopupremoveobjecttag_xml extends lime.utils.Bytes {}
...
@:file("Assets/Layout/UIPopupEditObjectTag.xml") #if display private #end class __ASSET__assets_layout_uipopupeditobjecttag_xml extends lime.utils.Bytes {}
@:file("Assets/Layout/UIPopupAddObjectTag.xml") #if display private #end class __ASSET__assets_layout_uipopupaddobjecttag_xml extends lime.utils.Bytes {}
@:file("Assets/Layout/UIPopupEditObjectVisitor.xml") #if display private #end class __ASSET__layout_uipopupeditobjectvisitor_xml extends lime.utils.Bytes {}
...
@:file("Assets/Layout/UIPopupAddObjectVisitor.xml") #if display private #end class __ASSET__layout_uipopupaddobjectvisitor_xml extends lime.utils.Bytes {}
@:file("Assets/Layout/UIPopupRemoveObjectVisitor.xml") #if display private #end class __ASSET__layout_uipopupremoveobjectvisitor_xml extends lime.utils.Bytes {}
...
@:file("Assets/Layout/UIPopupRemoveObjectTag.xml") #if display private #end class __ASSET__layout_uipopupremoveobjecttag_xml extends lime.utils.Bytes {}
...
@:file("Assets/Layout/UIPopupEditObjectTag.xml") #if display private #end class __ASSET__layout_uipopupeditobjecttag_xml extends lime.utils.Bytes {}
@:file("Assets/Layout/UIPopupAddObjectTag.xml") #if display private #end class __ASSET__layout_uipopupaddobjecttag_xml extends lime.utils.Bytes {}
