...
class IItemRenderer_delegate_ : public IItemRenderer_obj
{
	...
	public:
		...
		Dynamic set_data( Dynamic value) { return mDelegate->set_data(value);}
		Dynamic set_data_dyn() { return mDelegate->set_data_dyn();}
		bool allowSelection( Float stageX,Float stageY) { return mDelegate->allowSelection(stageX,stageY);}
		Dynamic allowSelection_dyn() { return mDelegate->allowSelection_dyn();}
		Void update( ) { return mDelegate->update();}
		Dynamic update_dyn() { return mDelegate->update_dyn();}
		::String get_state( ) { return mDelegate->get_state();}
		Dynamic get_state_dyn() { return mDelegate->get_state_dyn();}
		::String set_state( ::String value) { return mDelegate->set_state(value);}
		Dynamic set_state_dyn() { return mDelegate->set_state_dyn();}
		Array< ::String > get_states( ) { return mDelegate->get_states();}
		Dynamic get_states_dyn() { return mDelegate->get_states_dyn();}
		bool hasState( ::String state) { return mDelegate->hasState(state);}
		Dynamic hasState_dyn() { return mDelegate->hasState_dyn();}
