...
class HXCPP_CLASS_ATTRIBUTES  ExpandableButton_obj : public ::haxe::ui::toolkit::controls::Button_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxe.ui.toolkit.containers.ExpandableButton")
		...
		::String __ToString() const { return HX_HCSTRING("ExpandableButton","\x26","\x72","\x2b","\xeb"); }
