...
class HXCPP_CLASS_ATTRIBUTES  AccordionButton_obj : public ::haxe::ui::toolkit::controls::Button_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxe.ui.toolkit.containers.AccordionButton")
		...
		::String __ToString() const { return HX_HCSTRING("AccordionButton","\x7a","\xde","\x0f","\x57"); }
