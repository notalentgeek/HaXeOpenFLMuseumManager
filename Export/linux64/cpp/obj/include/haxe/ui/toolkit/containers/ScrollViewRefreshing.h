...
#define INCLUDED_haxe_ui_toolkit_containers_ScrollViewRefreshing
...
class HXCPP_CLASS_ATTRIBUTES  ScrollViewRefreshing_obj : public ::haxe::ui::toolkit::containers::VBox_obj{
	public:
		typedef ::haxe::ui::toolkit::containers::VBox_obj super;
		typedef ScrollViewRefreshing_obj OBJ_;
		ScrollViewRefreshing_obj();
		Void __construct();

	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxe.ui.toolkit.containers.ScrollViewRefreshing")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		static hx::ObjectPtr< ScrollViewRefreshing_obj > __new();
		...
		::String __ToString() const { return HX_HCSTRING("ScrollViewRefreshing","\xb9","\x89","\x68","\xd9"); }
...
#endif /* INCLUDED_haxe_ui_toolkit_containers_ScrollViewRefreshing */ 
