...
class HXCPP_CLASS_ATTRIBUTES  TextInputLayout_obj : public ::haxe::ui::toolkit::layout::DefaultLayout_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxe.ui.toolkit.controls.TextInputLayout")
		...
		::String __ToString() const { return HX_HCSTRING("TextInputLayout","\x87","\xf2","\x09","\x60"); }
		...
		virtual ::openfl::_legacy::text::TextField findTextField( );
