...
class HXCPP_CLASS_ATTRIBUTES  InvalidationFlag_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="haxe.ui.toolkit.core.interfaces.InvalidationFlag")
		...
		::String __ToString() const { return HX_HCSTRING("InvalidationFlag","\x4a","\xb3","\xab","\x7c"); }
