...
class Expr_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		static ::hscript::Expr EFunction(cpp::ArrayBase args,::hscript::Expr e,::String name,::hscript::CType ret);
		...
		static ::hscript::Expr EObject(cpp::ArrayBase fl);
		...
		static ::hscript::Expr ESwitch(::hscript::Expr e,cpp::ArrayBase cases,::hscript::Expr defaultExpr);
