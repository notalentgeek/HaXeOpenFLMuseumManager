...
virtual ::motion::actuators::IGenericActuator onComplete( Dynamic handler,cpp::ArrayBase parameters) { return mDelegate->onComplete(handler,parameters);}  \
virtual Dynamic onComplete_dyn() { return mDelegate->onComplete_dyn();}  \
virtual ::motion::actuators::IGenericActuator onRepeat( Dynamic handler,cpp::ArrayBase parameters) { return mDelegate->onRepeat(handler,parameters);}  \
virtual Dynamic onRepeat_dyn() { return mDelegate->onRepeat_dyn();}  \
virtual ::motion::actuators::IGenericActuator onUpdate( Dynamic handler,cpp::ArrayBase parameters) { return mDelegate->onUpdate(handler,parameters);}  \
...
virtual ::motion::actuators::IGenericActuator onPause( Dynamic handler,cpp::ArrayBase parameters) { return mDelegate->onPause(handler,parameters);}  \
virtual Dynamic onPause_dyn() { return mDelegate->onPause_dyn();}  \
virtual ::motion::actuators::IGenericActuator onResume( Dynamic handler,cpp::ArrayBase parameters) { return mDelegate->onResume(handler,parameters);}  \
