...
#define INCLUDED_UIPopupEditObjectTag
...
class HXCPP_CLASS_ATTRIBUTES  UIPopupEditObjectTag_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef UIPopupEditObjectTag_obj OBJ_;
		UIPopupEditObjectTag_obj();
		Void __construct(::CollectionGlobal _collectionGlobalObject,::haxe::ui::toolkit::core::Root _root);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="UIPopupEditObjectTag")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		static hx::ObjectPtr< UIPopupEditObjectTag_obj > __new(::CollectionGlobal _collectionGlobalObject,::haxe::ui::toolkit::core::Root _root);
		...
		::String __ToString() const { return HX_HCSTRING("UIPopupEditObjectTag","\x19","\x87","\xf5","\xbc"); }
		...
		::String selectTagNameListSelectorPrevString;
		::String selectTagNameListSelectorString;
...
#endif /* INCLUDED_UIPopupEditObjectTag */ 
