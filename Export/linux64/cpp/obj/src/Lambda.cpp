...
bool Lambda_obj::has( Dynamic it,Dynamic elt){
	HX_STACK_FRAME("Lambda","has",0x3d8bd693,"Lambda.has","/home/notalentgeek//Mikael Data/Programming Resouce/SDK/haxe-3.2.1/std/Lambda.hx",98,0xcc85af02)
	HX_STACK_ARG(it,"it")
...
bool Lambda_obj::exists( Dynamic it,Dynamic f){
	HX_STACK_FRAME("Lambda","exists",0x65091043,"Lambda.exists","/home/notalentgeek//Mikael Data/Programming Resouce/SDK/haxe-3.2.1/std/Lambda.hx",115,0xcc85af02)
	HX_STACK_ARG(it,"it")
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(116)
	Dynamic tmp = it->__Field(HX_HCSTRING("iterator","\xee","\x49","\x9a","\x93"), hx::paccDynamic )();		HX_STACK_VAR(tmp,"tmp");
...
int Lambda_obj::indexOf( Dynamic it,Dynamic v){
	HX_STACK_FRAME("Lambda","indexOf",0xbf6a7082,"Lambda.indexOf","/home/notalentgeek//Mikael Data/Programming Resouce/SDK/haxe-3.2.1/std/Lambda.hx",217,0xcc85af02)
	HX_STACK_ARG(it,"it")
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(218)
