...
#include <haxe/ui/toolkit/containers/HSplitter.h>
#endif
...
Void HSplitter_obj::__construct()
{
HX_STACK_FRAME("haxe.ui.toolkit.containers.HSplitter","new",0xeed69387,"haxe.ui.toolkit.containers.HSplitter.new","haxe/ui/toolkit/containers/HSplitter.hx",19,0xd34bd4c9)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(19)
	super::__construct();
...
//HSplitter_obj::~HSplitter_obj() { }

Dynamic HSplitter_obj::__CreateEmpty() { return  new HSplitter_obj; }
hx::ObjectPtr< HSplitter_obj > HSplitter_obj::__new()
{  hx::ObjectPtr< HSplitter_obj > _result_ = new HSplitter_obj();
	_result_->__construct();
	return _result_;}

Dynamic HSplitter_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< HSplitter_obj > _result_ = new HSplitter_obj();
	_result_->__construct();
	return _result_;}

hx::Object *HSplitter_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::haxe::ui::toolkit::core::interfaces::IClonable_obj)) return operator ::haxe::ui::toolkit::core::interfaces::IClonable_obj *();
	return super::__ToInterface(inType);
}

HSplitter_obj::operator ::haxe::ui::toolkit::core::interfaces::IClonable_obj *()
	{ return new ::haxe::ui::toolkit::core::interfaces::IClonable_delegate_< HSplitter_obj >(this); }
::haxe::ui::toolkit::core::interfaces::IDisplayObject HSplitter_obj::addChild( ::haxe::ui::toolkit::core::interfaces::IDisplayObject child){
	HX_STACK_FRAME("haxe.ui.toolkit.containers.HSplitter","addChild",0x289c3f34,"haxe.ui.toolkit.containers.HSplitter.addChild","haxe/ui/toolkit/containers/HSplitter.hx",22,0xd34bd4c9)
	HX_STACK_THIS(this)
	...
	HX_STACK_LINE(24)
	bool tmp1 = ::Std_obj::is(tmp,hx::ClassOf< ::haxe::ui::toolkit::containers::HSplitterGripper >());		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(24)
	if ((tmp1)){
		HX_STACK_LINE(25)
		...
		if ((tmp3)){
			HX_STACK_LINE(28)
			::haxe::ui::toolkit::containers::HSplitterGripper tmp4 = ::haxe::ui::toolkit::containers::HSplitterGripper_obj::__new();		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(28)
			::haxe::ui::toolkit::containers::HSplitterGripper gripper = tmp4;		HX_STACK_VAR(gripper,"gripper");
			HX_STACK_LINE(29)
			...
			HX_STACK_LINE(30)
			::haxe::ui::toolkit::containers::HSplitterGripper tmp7 = gripper;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(30)
			this->addChild(tmp7);
		}
		HX_STACK_LINE(32)
...
::haxe::ui::toolkit::core::interfaces::IDisplayObject HSplitter_obj::addChildAt( ::haxe::ui::toolkit::core::interfaces::IDisplayObject child,int index){
	HX_STACK_FRAME("haxe.ui.toolkit.containers.HSplitter","addChildAt",0xb791ad47,"haxe.ui.toolkit.containers.HSplitter.addChildAt","haxe/ui/toolkit/containers/HSplitter.hx",37,0xd34bd4c9)
	HX_STACK_THIS(this)
	HX_STACK_ARG(child,"child")
...
::haxe::ui::toolkit::core::interfaces::IDisplayObject HSplitter_obj::removeChild( ::haxe::ui::toolkit::core::interfaces::IDisplayObject child,hx::Null< bool >  __o_dispose){
bool dispose = __o_dispose.Default(true);
	HX_STACK_FRAME("haxe.ui.toolkit.containers.HSplitter","removeChild",0x8a3248df,"haxe.ui.toolkit.containers.HSplitter.removeChild","haxe/ui/toolkit/containers/HSplitter.hx",52,0xd34bd4c9)
	HX_STACK_THIS(this)
	HX_STACK_ARG(child,"child")
...
Void HSplitter_obj::_onMouseDown( ::haxe::ui::toolkit::events::UIEvent event){
{
		HX_STACK_FRAME("haxe.ui.toolkit.containers.HSplitter","_onMouseDown",0xacf46202,"haxe.ui.toolkit.containers.HSplitter._onMouseDown","haxe/ui/toolkit/containers/HSplitter.hx",65,0xd34bd4c9)
		HX_STACK_THIS(this)
		...
		HX_STACK_LINE(67)
		this->_gripper = ((::haxe::ui::toolkit::containers::HSplitterGripper)(tmp1));
		HX_STACK_LINE(68)
		Float tmp2 = event->stageX;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(68)
		::haxe::ui::toolkit::containers::HSplitterGripper tmp3 = this->_gripper;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(68)
		...
		HX_STACK_LINE(71)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(72)
				bool tmp10 = ::Std_obj::is(tmp9,hx::ClassOf< ::haxe::ui::toolkit::containers::HSplitterGripper >());		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(72)
				bool tmp11 = (tmp10 == false);		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(72)
				if ((tmp11)){
					HX_STACK_LINE(73)
					Float tmp12 = c->get_percentWidth();		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(73)
					...
					if ((tmp13)){
						...
						{
							HX_STACK_LINE(74)
							Float tmp14 = c->get_percentWidth();		HX_STACK_VAR(tmp14,"tmp14");
							HX_STACK_LINE(74)
...
HX_DEFINE_DYNAMIC_FUNC1(HSplitter_obj,_onMouseDown,(void))

Void HSplitter_obj::_onMouseMove( ::openfl::_legacy::events::MouseEvent event){
{
		HX_STACK_FRAME("haxe.ui.toolkit.containers.HSplitter","_onMouseMove",0xb2e74cb1,"haxe.ui.toolkit.containers.HSplitter._onMouseMove","haxe/ui/toolkit/containers/HSplitter.hx",86,0xd34bd4c9)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(87)
		::haxe::ui::toolkit::containers::HSplitterGripper tmp = this->_gripper;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(87)
		...
		if ((tmp1)){
			...
			HX_STACK_LINE(90)
			::haxe::ui::toolkit::containers::HSplitterGripper tmp8 = this->_gripper;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(90)
			...
			HX_STACK_LINE(94)
			Float tmp14 = before->get_width();		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(94)
			...
			HX_STACK_LINE(95)
			Float tmp17 = after->get_width();		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(95)
			...
			HX_STACK_LINE(96)
			Float tmp21 = before->get_minWidth();		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(96)
			...
			if ((tmp23)){
				...
				HX_STACK_LINE(96)
				Float tmp26 = after->get_minWidth();		HX_STACK_VAR(tmp26,"tmp26");
				HX_STACK_LINE(96)
			...
			if ((tmp25)){
				...
				HX_STACK_LINE(97)
				Float tmp34 = tmp33->get_left();		HX_STACK_VAR(tmp34,"tmp34");
				HX_STACK_LINE(97)
			...
			if ((tmp26)){
				...
				::openfl::_legacy::geom::Rectangle tmp32 = tmp31;		HX_STACK_VAR(tmp32,"tmp32");
				HX_STACK_LINE(98)
				Float tmp33 = tmp32->get_left();		HX_STACK_VAR(tmp33,"tmp33");
				HX_STACK_LINE(98)
				...
				HX_STACK_LINE(98)
				Float tmp39 = tmp38->get_right();		HX_STACK_VAR(tmp39,"tmp39");
				HX_STACK_LINE(98)
...
HX_DEFINE_DYNAMIC_FUNC1(HSplitter_obj,_onMouseMove,(void))

Void HSplitter_obj::_onMouseUp( ::openfl::_legacy::events::MouseEvent event){
{
		HX_STACK_FRAME("haxe.ui.toolkit.containers.HSplitter","_onMouseUp",0xdd1b27fb,"haxe.ui.toolkit.containers.HSplitter._onMouseUp","haxe/ui/toolkit/containers/HSplitter.hx",105,0xd34bd4c9)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(106)
		...
		HX_STACK_LINE(111)
		int tmp11 = tmp10->get_spacingX();		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(111)
		...
		for(::cpp::FastIterator_obj< ::haxe::ui::toolkit::core::interfaces::IDisplayObject > *__it = ::cpp::CreateFastIterator< ::haxe::ui::toolkit::core::interfaces::IDisplayObject >(tmp15);  __it->hasNext(); ){
			...
			{
				HX_STACK_LINE(120)
				Float tmp16 = c->get_width();		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(120)
...
HX_DEFINE_DYNAMIC_FUNC1(HSplitter_obj,_onMouseUp,(void))

::haxe::ui::toolkit::core::DisplayObject HSplitter_obj::clone( ){
	HX_STACK_FRAME("haxe.ui.toolkit.containers.HSplitter","clone",0xef7a2e44,"haxe.ui.toolkit.containers.HSplitter.clone","src/haxe/ui/toolkit/containers/HSplitter.hx",1,0x609c675e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(2)
	::haxe::ui::toolkit::containers::HBox tmp = hx::TCast< ::haxe::ui::toolkit::containers::HBox >::cast(this->super::clone());		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(2)
	::haxe::ui::toolkit::containers::HSplitter c = ((::haxe::ui::toolkit::containers::HSplitter)(tmp));		HX_STACK_VAR(c,"c");
	HX_STACK_LINE(3)
	::haxe::ui::toolkit::containers::HSplitter tmp1 = c;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(3)
	return tmp1;
}


::haxe::ui::toolkit::core::DisplayObject HSplitter_obj::self( ){
	HX_STACK_FRAME("haxe.ui.toolkit.containers.HSplitter","self",0x10388a85,"haxe.ui.toolkit.containers.HSplitter.self","src/haxe/ui/toolkit/containers/HSplitter.hx",1,0x609c675e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(2)
	::haxe::ui::toolkit::containers::HSplitter tmp = ::haxe::ui::toolkit::containers::HSplitter_obj::__new();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(2)
	return tmp;
}
...
void HSplitter_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(HSplitter);
...
void HSplitter_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic HSplitter_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic HSplitter_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"_gripper") ) { _gripper=inValue.Cast< ::haxe::ui::toolkit::containers::HSplitterGripper >(); return inValue; }
		break;
	case 9:
...
bool HSplitter_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}

void HSplitter_obj::__GetFields(Array< ::String> &outFields)
{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::haxe::ui::toolkit::containers::HSplitterGripper*/ ,(int)offsetof(HSplitter_obj,_gripper),HX_HCSTRING("_gripper","\xcc","\x66","\xfa","\x48")},
	{hx::fsObject /*::haxe::ds::ObjectMap*/ ,(int)offsetof(HSplitter_obj,_percents),HX_HCSTRING("_percents","\x6d","\xb9","\x10","\x8e")},
	{hx::fsFloat,(int)offsetof(HSplitter_obj,_mouseDownOffset),HX_HCSTRING("_mouseDownOffset","\x9b","\xd6","\xd5","\x98")},
	{ hx::fsUnknown, 0, null()}
};
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(HSplitter_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(HSplitter_obj::__mClass,"__mClass");
};

#endif

hx::Class HSplitter_obj::__mClass;

void HSplitter_obj::__register()
{
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("haxe.ui.toolkit.containers.HSplitter","\x15","\xc4","\xfe","\x57");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &HSplitter_obj::__SetStatic;
	__mClass->mMarkFunc = sMarkStatics;
	__mClass->mStatics = hx::Class_obj::dupFunctions(0 /* sStaticFields */);
	__mClass->mMembers = hx::Class_obj::dupFunctions(sMemberFields);
	__mClass->mCanCast = hx::TCanCast< HSplitter_obj >;
#ifdef HXCPP_VISIT_ALLOCS
