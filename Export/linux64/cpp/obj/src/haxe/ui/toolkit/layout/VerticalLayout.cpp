...
{  hx::ObjectPtr< VerticalLayout_obj > _result_ = new VerticalLayout_obj();
...
Void VerticalLayout_obj::resizeChildren( ){
{
		...
		HX_STACK_LINE(21)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(37)
				Float tmp14 = child->get_height();		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(37)
				hx::AddEq(totalHeight,tmp14);
				HX_STACK_LINE(38)
				Float tmp15 = child->get_width();		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(38)
				Float tmp16 = totalWidth;		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(38)
...
{
		HX_STACK_FRAME("haxe.ui.toolkit.layout.VerticalLayout","repositionChildren",0x2336e287,"haxe.ui.toolkit.layout.VerticalLayout.repositionChildren","haxe/ui/toolkit/layout/VerticalLayout.hx",50,0xfcb5c55c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(51)
		...
		HX_STACK_LINE(52)
		Float tmp1 = tmp->get_top();		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(52)
		...
		HX_STACK_LINE(53)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(59)
				Float tmp11 = tmp10->get_left();		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(59)
				Float xpos = tmp11;		HX_STACK_VAR(xpos,"xpos");
				HX_STACK_LINE(60)
				::String tmp12 = child->get_horizontalAlign();		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(60)
				::String halign = tmp12;		HX_STACK_VAR(halign,"halign");
				HX_STACK_LINE(62)
				::String tmp13 = halign;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(62)
...
;
				...
				HX_STACK_LINE(73)
				int tmp17 = this->get_spacingY();		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(73)
...
Float VerticalLayout_obj::get_usableHeight( ){
	HX_STACK_FRAME("haxe.ui.toolkit.layout.VerticalLayout","get_usableHeight",0x4f0be454,"haxe.ui.toolkit.layout.VerticalLayout.get_usableHeight","haxe/ui/toolkit/layout/VerticalLayout.hx",80,0xfcb5c55c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(81)
	...
	HX_STACK_LINE(94)
	{
		...
		while((true)){
			...
			HX_STACK_LINE(100)
			Float tmp10 = child->get_height();		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(100)
			...
			if ((tmp11)){
				HX_STACK_LINE(100)
				Float tmp13 = child->get_percentHeight();		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(100)
			...
			if ((tmp12)){
				HX_STACK_LINE(101)
				Float tmp13 = child->get_height();		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(101)
				hx::SubEq(ucy,tmp13);
			}
		}
	...
	HX_STACK_LINE(105)
	bool tmp2 = (ucy < (int)0);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(105)
	if ((tmp2)){
		HX_STACK_LINE(106)
		ucy = (int)0;
	...
	HX_STACK_LINE(109)
	Float tmp3 = ucy;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(109)
	return tmp3;
}


::haxe::ui::toolkit::layout::Layout VerticalLayout_obj::clone( ){
	HX_STACK_FRAME("haxe.ui.toolkit.layout.VerticalLayout","clone",0xb5f3b111,"haxe.ui.toolkit.layout.VerticalLayout.clone","src/haxe/ui/toolkit/layout/VerticalLayout.hx",1,0x15e57527)
	HX_STACK_THIS(this)
	HX_STACK_LINE(2)
	::haxe::ui::toolkit::layout::Layout tmp = this->super::clone();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(2)
	::haxe::ui::toolkit::layout::VerticalLayout c = ((::haxe::ui::toolkit::layout::VerticalLayout)(tmp));		HX_STACK_VAR(c,"c");
	HX_STACK_LINE(3)
	::haxe::ui::toolkit::layout::VerticalLayout tmp1 = c;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(3)
	return tmp1;
}


::haxe::ui::toolkit::layout::Layout VerticalLayout_obj::self( ){
	HX_STACK_FRAME("haxe.ui.toolkit.layout.VerticalLayout","self",0x76222058,"haxe.ui.toolkit.layout.VerticalLayout.self","src/haxe/ui/toolkit/layout/VerticalLayout.hx",1,0x15e57527)
	HX_STACK_THIS(this)
	HX_STACK_LINE(2)
...
Dynamic VerticalLayout_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
void VerticalLayout_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("haxe.ui.toolkit.layout.VerticalLayout","\x22","\xff","\x82","\x54");
