...
bool SpriteContainer_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void SpriteContainer_obj::__register()
{
	...
	__mClass->mSetStaticField = &SpriteContainer_obj::__SetStatic;
