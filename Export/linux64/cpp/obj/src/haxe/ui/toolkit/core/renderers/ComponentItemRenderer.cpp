...
bool ComponentItemRenderer_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void ComponentItemRenderer_obj::__register()
{
	...
	__mClass->mSetStaticField = &ComponentItemRenderer_obj::__SetStatic;
