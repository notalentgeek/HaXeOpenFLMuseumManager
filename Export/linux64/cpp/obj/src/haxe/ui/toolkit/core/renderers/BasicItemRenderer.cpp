...
bool BasicItemRenderer_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void BasicItemRenderer_obj::__register()
{
	...
	__mClass->mSetStaticField = &BasicItemRenderer_obj::__SetStatic;
