...
bool SimplePopupContent_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void SimplePopupContent_obj::__register()
{
	...
	__mClass->mSetStaticField = &SimplePopupContent_obj::__SetStatic;
