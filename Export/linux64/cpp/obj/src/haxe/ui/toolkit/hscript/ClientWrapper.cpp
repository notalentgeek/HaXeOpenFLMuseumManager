...
bool ClientWrapper_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void ClientWrapper_obj::__register()
{
	...
	__mClass->mSetStaticField = &ClientWrapper_obj::__SetStatic;
