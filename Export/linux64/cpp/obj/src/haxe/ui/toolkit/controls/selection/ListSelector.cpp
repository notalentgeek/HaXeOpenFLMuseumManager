...
bool ListSelector_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void ListSelector_obj::__register()
{
	...
	__mClass->mSetStaticField = &ListSelector_obj::__SetStatic;
