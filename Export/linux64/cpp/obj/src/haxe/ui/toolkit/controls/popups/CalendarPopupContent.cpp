...
bool CalendarPopupContent_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void CalendarPopupContent_obj::__register()
{
	...
	__mClass->mSetStaticField = &CalendarPopupContent_obj::__SetStatic;
