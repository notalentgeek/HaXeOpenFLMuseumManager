					...
					HX_STACK_LINE(543)
					{
						...
						struct _Function_4_1{
							inline static Dynamic Block( ){
								...
								{
									hx::Anon __result = hx::Anon_obj::Create();
									__result->Add(HX_HCSTRING("file","\x7c","\xce","\xbb","\x43") , HX_HCSTRING("/home/notalentgeek/Mikael Data/Programming Resouce/SDK/haxe-3.2.1 HaXeLib/haxeui/1,8,17/haxe/ui/toolkit/core/Macros.hx","\xae","\x9d","\x0c","\xad"),false);
...
bool Macros_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 14:
		if (HX_FIELD_EQ(inName,"themeResources") ) { themeResources=ioValue.Cast< ::haxe::ds::StringMap >(); return true; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"componentClasses") ) { componentClasses=ioValue.Cast< ::haxe::ds::StringMap >(); return true; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"dataSourceClasses") ) { dataSourceClasses=ioValue.Cast< ::haxe::ds::StringMap >(); return true; }
	}
	return false;
}
