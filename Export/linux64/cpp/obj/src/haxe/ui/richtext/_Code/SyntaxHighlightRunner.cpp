...
bool SyntaxHighlightRunner_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void SyntaxHighlightRunner_obj::__register()
{
	...
	__mClass->mSetStaticField = &SyntaxHighlightRunner_obj::__SetStatic;
