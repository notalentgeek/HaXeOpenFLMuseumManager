...
::String Resource_obj::getString( ::String name){
	HX_STACK_FRAME("haxe.Resource","getString",0x974269cf,"haxe.Resource.getString","/home/notalentgeek//Mikael Data/Programming Resouce/SDK/haxe-3.2.1/std/cpp/_std/haxe/Resource.hx",30,0x2528b1d1)
...
::haxe::io::Bytes Resource_obj::getBytes( ::String name){
	HX_STACK_FRAME("haxe.Resource","getBytes",0x9bc1712d,"haxe.Resource.getBytes","/home/notalentgeek//Mikael Data/Programming Resouce/SDK/haxe-3.2.1/std/cpp/_std/haxe/Resource.hx",33,0x2528b1d1)
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(34)
