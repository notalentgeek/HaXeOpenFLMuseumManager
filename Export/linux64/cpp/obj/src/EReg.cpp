...
int len = __o_len.Default(-1);
	HX_STACK_FRAME("EReg","matchSub",0xbc75cb7a,"EReg.matchSub","/usr/lib/haxe/std/cpp/_std/EReg.hx",65,0x16cad931)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
...
::String EReg_obj::map( ::String s,Dynamic f){
	HX_STACK_FRAME("EReg","map",0x8b84d8bd,"EReg.map","/usr/lib/haxe/std/cpp/_std/EReg.hx",149,0x16cad931)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(150)
