...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(29)
		::openfl::_legacy::Lib_obj::setPackage(HX_HCSTRING("Company Name","\x4e","\x48","\x0d","\xcb"),HX_HCSTRING("HaXeOpenFLMuseumManager","\x45","\x2b","\x0b","\x39"),HX_HCSTRING("com.sample.haxeopenflmuseummanager","\x2e","\x2b","\x95","\x3f"),HX_HCSTRING("1.0.0","\xb5","\xd1","\x2e","\x55"));
		HX_STACK_LINE(133)
		...
		HX_STACK_LINE(52)
		::openfl::_legacy::Lib_obj::create( Dynamic(new _Function_1_1()),(int)1024,(int)576,(int)60,(int)16777215,tmp22,HX_HCSTRING("HaXeOpenFLMuseumManager","\x45","\x2b","\x0b","\x39"),null(),null());
	}
return null();
}
