...
Void CollectionPremade_obj::PremadeExhibitionNewObjectVoid( ::CollectionGlobal _collectionGlobalObject){
{
		...
		HX_STACK_LINE(100)
		Array< ::String > exhibition004ExplanationStringArray = Array_obj< ::String >::__new().Add(HX_HCSTRING("Pendant jewel; gold; oval; set with twenty-five square table diamonds and four rose diamonds.","\x75","\xcd","\x32","\xde")).Add(HX_HCSTRING("Contains miniature portrait of James I as a young man.","\xcf","\x85","\xbf","\x94")).Add(HX_HCSTRING("Cover in open-work with diamonds on outside and enamel within.","\xbf","\xa1","\x04","\xfd")).Add(HX_HCSTRING("Frame of square diamonds connected by slender enamelled band; back is white enamel plate with fine gold lines and ruby enamel.","\x6a","\xad","\xe3","\xc2")).Add(HX_HCSTRING("Edge enamelled alternately ruby and sapphire blue.","\x78","\x46","\x56","\xfc"));		HX_STACK_VAR(exhibition004ExplanationStringArray,"exhibition004ExplanationStringArray");
		HX_STACK_LINE(108)
