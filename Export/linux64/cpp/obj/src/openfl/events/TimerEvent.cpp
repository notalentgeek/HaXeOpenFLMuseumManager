...
::openfl::_legacy::events::Event TimerEvent_obj::clone( ){
	...
	HX_STACK_LINE(26)
	::openfl::events::TimerEvent tmp6 = event;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(26)
	return tmp6;
}
...
{
		HX_STACK_FRAME("openfl.events.TimerEvent","updateAfterEvent",0xcd7c1969,"openfl.events.TimerEvent.updateAfterEvent","openfl/events/TimerEvent.hx",38,0x5c7b7b12)
		HX_STACK_THIS(this)
	}
return null();
}
