...
HX_STACK_THIS(this)
{
	...
	Void run(::haxe::ui::toolkit::core::Root _root){
		...
		HX_STACK_ARG(_root,"_root")
		{
			...
			HX_STACK_LINE(59)
			::UIPopupRemoveObjectTag tmp6 = ::UIPopupRemoveObjectTag_obj::__new(_g->collectionGlobalObject,_root);		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(59)
			_g->uiPopupRemoveTagObject = tmp6;
			HX_STACK_LINE(60)
			::UIPopupRemoveObjectVisitor tmp7 = ::UIPopupRemoveObjectVisitor_obj::__new(_g->collectionGlobalObject,_root);		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(60)
			_g->uiPopupRemoveVisitorObject = tmp7;
			HX_STACK_LINE(62)
			::haxe::ui::toolkit::containers::Absolute tmp8 = _root->findChild(HX_HCSTRING("UIMuseumAbsolute","\xdd","\x3c","\xb2","\xbe"),hx::ClassOf< ::haxe::ui::toolkit::containers::Absolute >(),true);		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(62)
			::haxe::ui::toolkit::containers::Absolute uiMuseumAbsoluteObject = tmp8;		HX_STACK_VAR(uiMuseumAbsoluteObject,"uiMuseumAbsoluteObject");
			HX_STACK_LINE(63)
			::haxe::ui::toolkit::containers::Absolute tmp9 = uiMuseumAbsoluteObject;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(63)
			_g->collectionGlobalObject->SetUIMuseumAbsoluteObjectVoid(tmp9);
		}
		return null();
	}
...
{
		HX_STACK_FRAME("Main","Update",0xec44199e,"Main.Update","Main.hx",81,0x087e5c05)
		HX_STACK_THIS(this)
		...
		tmp2->UpdateVoid();
		HX_STACK_LINE(87)
		::UIPopupRemoveObjectTag tmp3 = this->uiPopupRemoveTagObject;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(87)
		tmp3->UpdateVoid();
		HX_STACK_LINE(88)
		::UIPopupRemoveObjectVisitor tmp4 = this->uiPopupRemoveVisitorObject;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(88)
		tmp4->UpdateVoid();
	}
return null();
...
{
		HX_STACK_FRAME("Main","UpdateSlowVoid",0xca6605b3,"Main.UpdateSlowVoid","Main.hx",104,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_LINE(107)
		::CollectionGlobal tmp = this->collectionGlobalObject;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(107)
...
{
		HX_STACK_FRAME("Main","UpdateNormalVoid",0x168c9059,"Main.UpdateNormalVoid","Main.hx",122,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_LINE(125)
		::CollectionGlobal tmp = this->collectionGlobalObject;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(125)
...
{
		HX_STACK_FRAME("Main","UpdateFastVoid",0xf8a3d3ce,"Main.UpdateFastVoid","Main.hx",143,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_LINE(145)
		int loopCounter1Int = (int)0;		HX_STACK_VAR(loopCounter1Int,"loopCounter1Int");
		HX_STACK_LINE(146)
