...
{
HX_STACK_FRAME("CollectionTagGeneral","new",0x640e4efe,"CollectionTagGeneral.new","CollectionTagGeneral.hx",16,0x9b6d1a32)
HX_STACK_THIS(this)
{
}
;
...
{
		HX_STACK_FRAME("CollectionTagGeneral","TagGeneralStructVoid",0x4ef62599,"CollectionTagGeneral.TagGeneralStructVoid","CollectionTagGeneral.hx",17,0x9b6d1a32)
...
{
		HX_STACK_FRAME("CollectionTagGeneral","TagGeneralStructAdjVoid",0x841b17f6,"CollectionTagGeneral.TagGeneralStructAdjVoid","CollectionTagGeneral.hx",35,0x9b6d1a32)
		HX_STACK_ARG(_collectionGlobalObject,"_collectionGlobalObject")
		HX_STACK_LINE(36)
		...
		HX_STACK_LINE(40)
		tmp4->SetAdjectiveStringObject(HX_HCSTRING("Soft","\x0a","\x49","\x31","\x37"));
	}
return null();
}
