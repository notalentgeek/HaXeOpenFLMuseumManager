...
HX_STACK_ARG(properties,"properties")
{
	...
	HX_STACK_LINE(21)
	::openfl::_legacy::display::DisplayObject tmp = target;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(21)
	...
	if ((tmp3)){
		...
		if ((tmp5)){
			...
			HX_STACK_LINE(28)
			::openfl::_legacy::filters::BitmapFilter tmp7 = ::Type_obj::createInstance(tmp6,cpp::ArrayBase_obj::__new());		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(28)
		...
		HX_STACK_LINE(31)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(31)
				::openfl::_legacy::filters::BitmapFilter tmp8 = _g1->__get(_g).StaticCast< ::openfl::_legacy::filters::BitmapFilter >();		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(31)
				::openfl::_legacy::filters::BitmapFilter filter = tmp8;		HX_STACK_VAR(filter,"filter");
				HX_STACK_LINE(31)
				++(_g);
				HX_STACK_LINE(33)
				::openfl::_legacy::filters::BitmapFilter tmp9 = filter;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(33)
		...
		HX_STACK_LINE(44)
		::openfl::_legacy::filters::BitmapFilter tmp5 = target->get_filters()->__get(tmp4).StaticCast< ::openfl::_legacy::filters::BitmapFilter >();		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(44)
		this->filter = tmp5;
	}
}
...
Void FilterActuator_obj::apply( ){
{
		...
		HX_STACK_LINE(53)
		{
			...
			while((true)){
				...
				if ((tmp4)){
					HX_STACK_LINE(57)
					::openfl::_legacy::filters::BitmapFilter tmp5 = this->filter;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(57)
		...
		{
			HX_STACK_LINE(63)
			::openfl::_legacy::display::DisplayObject tmp1 = this->target;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(63)
			::openfl::_legacy::display::DisplayObject target = tmp1;		HX_STACK_VAR(target,"target");
			HX_STACK_LINE(63)
			Dynamic value = null();		HX_STACK_VAR(value,"value");
			HX_STACK_LINE(63)
			::openfl::_legacy::display::DisplayObject tmp2 = target;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(63)
			bool tmp3 = ::Reflect_obj::hasField(tmp2,HX_HCSTRING("filters","\xbb","\xa1","\x46","\x09"));		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(63)
			if ((tmp3)){
				HX_STACK_LINE(63)
				::openfl::_legacy::display::DisplayObject tmp4 = target;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(63)
		...
		HX_STACK_LINE(64)
		::openfl::_legacy::filters::BitmapFilter tmp2 = this->filter;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(64)
		::Reflect_obj::setField(filters,tmp1->__Field(HX_HCSTRING("filter","\xb8","\x1f","\x35","\x85"), hx::paccDynamic ),tmp2);
		HX_STACK_LINE(65)
		{
			HX_STACK_LINE(65)
			::openfl::_legacy::display::DisplayObject tmp3 = this->target;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(65)
			::openfl::_legacy::display::DisplayObject target = tmp3;		HX_STACK_VAR(target,"target");
			HX_STACK_LINE(65)
			::openfl::_legacy::display::DisplayObject tmp4 = target;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(65)
			...
			if ((tmp5)){
				HX_STACK_LINE(65)
				::openfl::_legacy::display::DisplayObject tmp6 = target;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(65)
		...
		HX_STACK_LINE(75)
		{
			...
			while((true)){
				...
				if ((tmp4)){
					...
					{
						HX_STACK_LINE(79)
						::openfl::_legacy::filters::BitmapFilter tmp6 = this->filter;		HX_STACK_VAR(tmp6,"tmp6");
						HX_STACK_LINE(79)
						::openfl::_legacy::filters::BitmapFilter target = tmp6;		HX_STACK_VAR(target,"target");
						HX_STACK_LINE(79)
						Dynamic value = null();		HX_STACK_VAR(value,"value");
						HX_STACK_LINE(79)
						::openfl::_legacy::filters::BitmapFilter tmp7 = target;		HX_STACK_VAR(tmp7,"tmp7");
						HX_STACK_LINE(79)
						::String tmp8 = propertyName;		HX_STACK_VAR(tmp8,"tmp8");
						HX_STACK_LINE(79)
						...
						if ((tmp9)){
							HX_STACK_LINE(79)
							::openfl::_legacy::filters::BitmapFilter tmp10 = target;		HX_STACK_VAR(tmp10,"tmp10");
							HX_STACK_LINE(79)
...
Void FilterActuator_obj::update( Float currentTime){
{
		...
		if ((tmp3)){
			...
			while((true)){
				...
				HX_STACK_LINE(107)
				::openfl::_legacy::filters::BitmapFilter tmp7 = filters->__get(i).StaticCast< ::openfl::_legacy::filters::BitmapFilter >();		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(107)
				...
				if ((tmp9)){
					HX_STACK_LINE(109)
					::openfl::_legacy::filters::BitmapFilter tmp10 = this->filter;		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(109)
					filters[i] = tmp10;
				}
			}
		...
		{
			HX_STACK_LINE(117)
			::openfl::_legacy::display::DisplayObject tmp4 = this->target;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(117)
			::openfl::_legacy::display::DisplayObject target = tmp4;		HX_STACK_VAR(target,"target");
			HX_STACK_LINE(117)
			::openfl::_legacy::display::DisplayObject tmp5 = target;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(117)
			bool tmp6 = ::Reflect_obj::hasField(tmp5,HX_HCSTRING("filters","\xbb","\xa1","\x46","\x09"));		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(117)
			if ((tmp6)){
				HX_STACK_LINE(117)
				::openfl::_legacy::display::DisplayObject tmp7 = target;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(117)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_legacy::filters::BitmapFilter*/ ,(int)offsetof(FilterActuator_obj,filter),HX_HCSTRING("filter","\xb8","\x1f","\x35","\x85")},
