...
HX_STACK_ARG(properties,"properties")
{
	...
	if ((tmp6)){
		...
		HX_STACK_LINE(81)
		::String tmp9 = ::openfl::_legacy::events::Event_obj::ENTER_FRAME;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(81)
		Dynamic tmp10 = ::motion::actuators::SimpleActuator_obj::stage_onEnterFrame_dyn();		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(81)
...
Void SimpleActuator_obj::setField_openfl__legacy_geom_Transform( ::openfl::_legacy::geom::Transform target,::String propertyName,Dynamic value){
{
		HX_STACK_FRAME("motion.actuators.SimpleActuator","setField_openfl__legacy_geom_Transform",0xe870b25f,"motion.actuators.SimpleActuator.setField_openfl__legacy_geom_Transform","motion/actuators/SimpleActuator.hx",317,0x731927e5)
		HX_STACK_THIS(this)
		HX_STACK_ARG(target,"target")
		HX_STACK_ARG(propertyName,"propertyName")
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(319)
		::openfl::_legacy::geom::Transform tmp = target;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(319)
		...
		if ((tmp2)){
			HX_STACK_LINE(324)
			::openfl::_legacy::geom::Transform tmp3 = target;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(324)
...
HX_DEFINE_DYNAMIC_FUNC3(SimpleActuator_obj,setField_openfl__legacy_geom_Transform,(void))
...
Void SimpleActuator_obj::setField_openfl__legacy_display_DisplayObject( ::openfl::_legacy::display::DisplayObject target,::String propertyName,Dynamic value){
{
		HX_STACK_FRAME("motion.actuators.SimpleActuator","setField_openfl__legacy_display_DisplayObject",0x8de72bae,"motion.actuators.SimpleActuator.setField_openfl__legacy_display_DisplayObject","motion/actuators/SimpleActuator.hx",317,0x731927e5)
		HX_STACK_THIS(this)
		HX_STACK_ARG(target,"target")
		HX_STACK_ARG(propertyName,"propertyName")
		HX_STACK_ARG(value,"value")
		...
		if ((tmp2)){
			HX_STACK_LINE(324)
			::openfl::_legacy::display::DisplayObject tmp3 = target;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(324)
			::String tmp4 = propertyName;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(324)
			Dynamic tmp5 = value;		HX_STACK_VAR(tmp5,"tmp5");
...
HX_DEFINE_DYNAMIC_FUNC3(SimpleActuator_obj,setField_openfl__legacy_display_DisplayObject,(void))
...
Void SimpleActuator_obj::resume( ){
{
		...
		if ((tmp)){
			...
			this->paused = false;
			HX_STACK_LINE(299)
			int tmp1 = ::openfl::_legacy::Lib_obj::getTimer();		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(299)
...
static ::String sMemberFields[] = {
	HX_HCSTRING("setField_openfl__legacy_geom_Transform","\x88","\x7c","\x24","\x1f"),
	...
	HX_HCSTRING("setField_openfl__legacy_display_DisplayObject","\xa5","\xe8","\xb4","\xda"),
