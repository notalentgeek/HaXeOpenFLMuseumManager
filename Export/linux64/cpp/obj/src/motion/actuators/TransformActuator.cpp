...
Void TransformActuator_obj::apply( ){
{
		...
		this->initialize();
		HX_STACK_LINE(32)
		::openfl::_legacy::geom::ColorTransform tmp = this->endColorTransform;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(32)
		...
		if ((tmp1)){
			...
			HX_STACK_LINE(34)
			::openfl::_legacy::geom::Transform transform = tmp2;		HX_STACK_VAR(transform,"transform");
			HX_STACK_LINE(35)
			{
				HX_STACK_LINE(35)
				::openfl::_legacy::geom::ColorTransform tmp3 = this->endColorTransform;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(35)
				Dynamic value = tmp3;		HX_STACK_VAR(value,"value");
				HX_STACK_LINE(35)
				::openfl::_legacy::geom::Transform tmp4 = transform;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(35)
				bool tmp5 = ::Reflect_obj::hasField(tmp4,HX_HCSTRING("colorTransform","\x89","\xd7","\x3f","\xad"));		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(35)
				if ((tmp5)){
					HX_STACK_LINE(35)
					::openfl::_legacy::geom::Transform tmp6 = transform;		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(35)
...
Void TransformActuator_obj::initialize( ){
{
		...
		if ((tmp2)){
			...
			HX_STACK_LINE(50)
			tmp3 = ::Std_obj::is(tmp6,hx::ClassOf< ::openfl::_legacy::display::DisplayObject >());
		}
		else{
			HX_STACK_LINE(50)
			tmp3 = false;
...
Void TransformActuator_obj::initializeColor( ){
{
		...
		if ((tmp3)){
			...
			HX_STACK_LINE(92)
			::openfl::_legacy::geom::ColorTransform tmp5 = this->endColorTransform;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(92)
			tmp5->redMultiplier = multiplier;
			HX_STACK_LINE(93)
			::openfl::_legacy::geom::ColorTransform tmp6 = this->endColorTransform;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(93)
			tmp6->greenMultiplier = multiplier;
			HX_STACK_LINE(94)
			::openfl::_legacy::geom::ColorTransform tmp7 = this->endColorTransform;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(94)
			...
			HX_STACK_LINE(96)
			::openfl::_legacy::geom::ColorTransform tmp12 = this->endColorTransform;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(96)
			...
			HX_STACK_LINE(97)
			::openfl::_legacy::geom::ColorTransform tmp17 = this->endColorTransform;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(97)
			...
			HX_STACK_LINE(98)
			::openfl::_legacy::geom::ColorTransform tmp21 = this->endColorTransform;		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(98)
			tmp21->blueOffset = tmp20;
		}
		else{
			HX_STACK_LINE(104)
			::openfl::_legacy::geom::ColorTransform tmp4 = this->endColorTransform;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(104)
			...
			HX_STACK_LINE(108)
			::openfl::_legacy::geom::ColorTransform tmp9 = this->endColorTransform;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(108)
			tmp9->redOffset = tmp8;
			HX_STACK_LINE(109)
			...
			HX_STACK_LINE(110)
			::openfl::_legacy::geom::ColorTransform tmp14 = this->endColorTransform;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(110)
		...
		HX_STACK_LINE(127)
		::openfl::_legacy::geom::Transform transform = tmp6;		HX_STACK_VAR(transform,"transform");
		HX_STACK_LINE(128)
		...
		HX_STACK_LINE(128)
		{
			...
			Dynamic value = null();		HX_STACK_VAR(value,"value");
			HX_STACK_LINE(128)
			::openfl::_legacy::geom::Transform tmp8 = transform;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(128)
			bool tmp9 = ::Reflect_obj::hasField(tmp8,HX_HCSTRING("colorTransform","\x89","\xd7","\x3f","\xad"));		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(128)
			if ((tmp9)){
				HX_STACK_LINE(128)
				::openfl::_legacy::geom::Transform tmp10 = transform;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(128)
		...
		HX_STACK_LINE(128)
		::openfl::_legacy::geom::ColorTransform begin = tmp7;		HX_STACK_VAR(begin,"begin");
		HX_STACK_LINE(129)
		::openfl::_legacy::geom::ColorTransform tmp8 = ::openfl::_legacy::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(129)
		...
		HX_STACK_LINE(134)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(136)
				{
					...
					Dynamic value = null();		HX_STACK_VAR(value,"value");
					HX_STACK_LINE(136)
					::openfl::_legacy::geom::ColorTransform tmp13 = begin;		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(136)
					...
					if ((tmp15)){
						HX_STACK_LINE(136)
						::openfl::_legacy::geom::ColorTransform tmp16 = begin;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(136)
				...
				start = tmp12;
				HX_STACK_LINE(137)
				::openfl::_legacy::geom::ColorTransform tmp13 = this->tweenColorTransform;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(137)
				::String tmp14 = propertyName;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(137)
				...
				HX_STACK_LINE(137)
				{
					...
					::openfl::_legacy::geom::ColorTransform tmp17 = this->endColorTransform;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(137)
					::openfl::_legacy::geom::ColorTransform target = tmp17;		HX_STACK_VAR(target,"target");
					HX_STACK_LINE(137)
					Dynamic value = null();		HX_STACK_VAR(value,"value");
					HX_STACK_LINE(137)
					::openfl::_legacy::geom::ColorTransform tmp18 = target;		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(137)
					...
					if ((tmp20)){
						HX_STACK_LINE(137)
						::openfl::_legacy::geom::ColorTransform tmp21 = target;		HX_STACK_VAR(tmp21,"tmp21");
						HX_STACK_LINE(137)
...
Void TransformActuator_obj::update( Float currentTime){
{
		...
		HX_STACK_LINE(178)
		::openfl::_legacy::geom::ColorTransform tmp1 = this->endColorTransform;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(178)
		...
		if ((tmp2)){
			...
			HX_STACK_LINE(180)
			::openfl::_legacy::geom::Transform transform = tmp3;		HX_STACK_VAR(transform,"transform");
			HX_STACK_LINE(181)
			{
				HX_STACK_LINE(181)
				::openfl::_legacy::geom::ColorTransform tmp4 = this->tweenColorTransform;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(181)
				Dynamic value = tmp4;		HX_STACK_VAR(value,"value");
				HX_STACK_LINE(181)
				::openfl::_legacy::geom::Transform tmp5 = transform;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(181)
				bool tmp6 = ::Reflect_obj::hasField(tmp5,HX_HCSTRING("colorTransform","\x89","\xd7","\x3f","\xad"));		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(181)
				if ((tmp6)){
					HX_STACK_LINE(181)
					::openfl::_legacy::geom::Transform tmp7 = transform;		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(181)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_legacy::geom::ColorTransform*/ ,(int)offsetof(TransformActuator_obj,endColorTransform),HX_HCSTRING("endColorTransform","\xc4","\x58","\xc3","\xca")},
	...
	{hx::fsObject /*::openfl::_legacy::geom::ColorTransform*/ ,(int)offsetof(TransformActuator_obj,tweenColorTransform),HX_HCSTRING("tweenColorTransform","\x54","\x5b","\x47","\x72")},
