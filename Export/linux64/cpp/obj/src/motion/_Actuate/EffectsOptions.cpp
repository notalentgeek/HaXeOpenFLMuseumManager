...
::motion::actuators::IGenericActuator EffectsOptions_obj::filter( Dynamic reference,Dynamic properties){
	...
	HX_STACK_LINE(554)
	::openfl::_legacy::display::DisplayObject tmp = this->target;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(554)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_legacy::display::DisplayObject*/ ,(int)offsetof(EffectsOptions_obj,target),HX_HCSTRING("target","\x51","\xf3","\xec","\x86")},
	{ hx::fsUnknown, 0, null()}
};
