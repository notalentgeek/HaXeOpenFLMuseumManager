...
bool TransformOptions_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void TransformOptions_obj::__register()
{
	...
	__mClass->mSetStaticField = &TransformOptions_obj::__SetStatic;
