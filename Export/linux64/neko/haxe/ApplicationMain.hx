...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Company Name", "HaXeOpenFLMuseumManager", "com.sample.haxeopenflmuseummanager", "1.0.0");
		...
		telemetryConfig.app_name = "HaXeOpenFLMuseumManager";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "HaXeOpenFLMuseumManager", null, { width: 1024, height: 576 });
