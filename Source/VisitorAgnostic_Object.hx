class VisitorAgnostic_Object extends MuseumAndVisitorAgnostic_Object{
    ...
    private var indexGlobal_Int                                                 (null, null)        :Int            = -1; /*PENDING: Put this in super class.*/
    private var indexLocal_Int                                                  (null, null)        :Int            = -1; /*PENDING: Put this in super class.*/
    ...
    private function Reset_MuseumAndVisitor_Object():MuseumAndVisitor_Object{
        ...
        amountOfPreviousVisitedExhibitionCheck_Int  = -1;
