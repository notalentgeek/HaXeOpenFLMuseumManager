...
Void ObjectMuseum_obj::__construct(::CollectionGlobal _collectionGlobalObject,::String _nameAltString,::String _nameFullString,::String _parentNameAltString,::EnumMuseumType _typeEnum,cpp::ArrayBase _tagStructArray)
{
...
HX_STACK_ARG(_tagStructArray,"_tagStructArray")
{
	...
	HX_STACK_LINE(32)
	bool tmp5 = (tmp4 != HX_HCSTRING("EXH_000","\x26","\x62","\x7a","\x18"));		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(32)
	if ((tmp5)){
		HX_STACK_LINE(32)
...
hx::ObjectPtr< ObjectMuseum_obj > ObjectMuseum_obj::__new(::CollectionGlobal _collectionGlobalObject,::String _nameAltString,::String _nameFullString,::String _parentNameAltString,::EnumMuseumType _typeEnum,cpp::ArrayBase _tagStructArray)
{  hx::ObjectPtr< ObjectMuseum_obj > _result_ = new ObjectMuseum_obj();
	_result_->__construct(_collectionGlobalObject,_nameAltString,_nameFullString,_parentNameAltString,_typeEnum,_tagStructArray);
	return _result_;}
...
{
		HX_STACK_FRAME("ObjectMuseum","DetermineFullVoid",0x39b0f279,"ObjectMuseum.DetermineFullVoid","ObjectMuseum.hx",52,0x96e8244d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(53)
...
{
		HX_STACK_FRAME("ObjectMuseum","DetermineIndexVoid",0x93890cd0,"ObjectMuseum.DetermineIndexVoid","ObjectMuseum.hx",56,0x96e8244d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(57)
...
{
		HX_STACK_FRAME("ObjectMuseum","DetermineIndexGlobalVoid",0xa32e9cd3,"ObjectMuseum.DetermineIndexGlobalVoid","ObjectMuseum.hx",60,0x96e8244d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(61)
...
{
		HX_STACK_FRAME("ObjectMuseum","DetermineIndexLocalVoid",0x6cd91f63,"ObjectMuseum.DetermineIndexLocalVoid","ObjectMuseum.hx",75,0x96e8244d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(76)
		::EnumMuseumType tmp = this->typeEnum;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(76)
...
{
		HX_STACK_FRAME("ObjectMuseum","DetermineSiblingVoid",0x044fbd40,"ObjectMuseum.DetermineSiblingVoid","ObjectMuseum.hx",89,0x96e8244d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(90)
		Array< ::Dynamic > tempObjectArray = Array_obj< ::Dynamic >::__new();		HX_STACK_VAR(tempObjectArray,"tempObjectArray");
		HX_STACK_LINE(91)
...
{
		HX_STACK_FRAME("ObjectMuseum","RemoveTagByNameAltVoid",0x5a04b902,"ObjectMuseum.RemoveTagByNameAltVoid","ObjectMuseum.hx",102,0x96e8244d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_nameAltString,"_nameAltString")
		HX_STACK_LINE(102)
...
{
		HX_STACK_FRAME("ObjectMuseum","RemoveTagByStructVoid",0x15100359,"ObjectMuseum.RemoveTagByStructVoid","ObjectMuseum.hx",103,0x96e8244d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_tagStruct,"_tagStruct")
		HX_STACK_LINE(103)
		Dynamic tmp = _tagStruct;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("ObjectMuseum","ResetVoid",0x96ab3506,"ObjectMuseum.ResetVoid","ObjectMuseum.hx",104,0x96e8244d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(105)
		this->fullBool = false;
		HX_STACK_LINE(106)
...
{
		HX_STACK_FRAME("ObjectMuseum","DetermineChildVoid",0x6319285a,"ObjectMuseum.DetermineChildVoid","ObjectMuseum.hx",109,0x96e8244d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(110)
		Dynamic tmp = this->childStruct;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(110)
...
Dynamic ObjectMuseum_obj::GetChildStruct( ){
	HX_STACK_FRAME("ObjectMuseum","GetChildStruct",0xe7838cf8,"ObjectMuseum.GetChildStruct","ObjectMuseum.hx",140,0x96e8244d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(140)
	Dynamic tmp = this->childStruct;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(140)
...
Array< ::String > ObjectMuseum_obj::GetExplanationStringArray( ){
	HX_STACK_FRAME("ObjectMuseum","GetExplanationStringArray",0x0bf34da8,"ObjectMuseum.GetExplanationStringArray","ObjectMuseum.hx",141,0x96e8244d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(141)
...
bool ObjectMuseum_obj::GetFullBool( ){
	HX_STACK_FRAME("ObjectMuseum","GetFullBool",0x7d6b0f12,"ObjectMuseum.GetFullBool","ObjectMuseum.hx",142,0x96e8244d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(142)
...
::EnumMuseumMode ObjectMuseum_obj::GetMuseumModeEnum( ){
	HX_STACK_FRAME("ObjectMuseum","GetMuseumModeEnum",0x051f8f6f,"ObjectMuseum.GetMuseumModeEnum","ObjectMuseum.hx",143,0x96e8244d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(143)
...
Dynamic ObjectMuseum_obj::GetNameStruct( ){
	HX_STACK_FRAME("ObjectMuseum","GetNameStruct",0x46430cf9,"ObjectMuseum.GetNameStruct","ObjectMuseum.hx",144,0x96e8244d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(144)
	Dynamic tmp = this->nameStruct;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(144)
...
::ObjectMuseum ObjectMuseum_obj::GetParentObject( ){
	HX_STACK_FRAME("ObjectMuseum","GetParentObject",0x099b05c2,"ObjectMuseum.GetParentObject","ObjectMuseum.hx",145,0x96e8244d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(145)
	::ObjectMuseum tmp = this->parentObject;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(145)
...
cpp::ArrayBase ObjectMuseum_obj::GetTagStructArray( ){
	HX_STACK_FRAME("ObjectMuseum","GetTagStructArray",0xe48da943,"ObjectMuseum.GetTagStructArray","ObjectMuseum.hx",146,0x96e8244d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(146)
...
::EnumMuseumType ObjectMuseum_obj::GetTypeEnum( ){
	HX_STACK_FRAME("ObjectMuseum","GetTypeEnum",0xd81d7094,"ObjectMuseum.GetTypeEnum","ObjectMuseum.hx",147,0x96e8244d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(147)
	::EnumMuseumType tmp = this->typeEnum;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(147)
...
int ObjectMuseum_obj::GetVisitorCurrentInt( ){
	HX_STACK_FRAME("ObjectMuseum","GetVisitorCurrentInt",0x43f11eab,"ObjectMuseum.GetVisitorCurrentInt","ObjectMuseum.hx",148,0x96e8244d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(148)
	int tmp = this->visitorCurrentInt;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(148)
...
int ObjectMuseum_obj::GetVisitorTotalInt( ){
	HX_STACK_FRAME("ObjectMuseum","GetVisitorTotalInt",0xf507f8c0,"ObjectMuseum.GetVisitorTotalInt","ObjectMuseum.hx",149,0x96e8244d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(149)
...
{
		HX_STACK_FRAME("ObjectMuseum","SetNameAltStringVoid",0xc739009e,"ObjectMuseum.SetNameAltStringVoid","ObjectMuseum.hx",151,0x96e8244d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_nameAltString,"_nameAltString")
		HX_STACK_LINE(151)
		Dynamic tmp = this->nameStruct;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("ObjectMuseum","SetNameFullStringVoid",0xe87d4fe4,"ObjectMuseum.SetNameFullStringVoid","ObjectMuseum.hx",152,0x96e8244d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_nameFullString,"_nameFullString")
		HX_STACK_LINE(152)
		Dynamic tmp = this->nameStruct;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("ObjectMuseum","SetParentObjectVoid",0x9d87f142,"ObjectMuseum.SetParentObjectVoid","ObjectMuseum.hx",153,0x96e8244d)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ObjectMuseum","Reset",0xf1a39492,"ObjectMuseum.Reset","ObjectMuseum.hx",155,0x96e8244d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(156)
		this->fullBool = false;
		HX_STACK_LINE(157)
...
{
		HX_STACK_FRAME("ObjectMuseum","SetMuseumModeEnumVoid",0x4443306f,"ObjectMuseum.SetMuseumModeEnumVoid","ObjectMuseum.hx",161,0x96e8244d)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ObjectMuseum","SetVisitorCurrentIntVoid",0x5764c113,"ObjectMuseum.SetVisitorCurrentIntVoid","ObjectMuseum.hx",162,0x96e8244d)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ObjectMuseum","SetVisitorTotalIntVoid",0xde2bc4a8,"ObjectMuseum.SetVisitorTotalIntVoid","ObjectMuseum.hx",163,0x96e8244d)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ObjectMuseum","Update",0xfc0ba5e6,"ObjectMuseum.Update","ObjectMuseum.hx",165,0x96e8244d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(166)
		::EnumMuseumMode tmp = this->museumModeEnum;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(166)
