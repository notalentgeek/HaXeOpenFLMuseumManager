...
Void ObjectVisitor_obj::__construct()
{
HX_STACK_FRAME("ObjectVisitor","new",0x49949701,"ObjectVisitor.new","ObjectVisitor.hx",2,0xe713038f)
HX_STACK_THIS(this)
{
}
;
...
hx::ObjectPtr< ObjectVisitor_obj > ObjectVisitor_obj::__new()
